...
Regarding the finaltestdata: in order to set equals objects for model imputation, it shall be set the levels of the cvtd_timestamp predictor, from finaltestdata data, equals to the one from traindata object.
...
modelfit <- randomForest(classe~.,data=traindata, ntree=400)
```
